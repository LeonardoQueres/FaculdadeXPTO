...
namespace Aplication.ViewModel
{
    public class TurmaViewModel : BaseViewModel
    {
        ...
        public TurmaAlunoTelaViewModel TelaTurmaAluno { get; set; } = new TurmaAlunoTelaViewModel();
        public TurmaDisciplinaTelaViewModel TelaTurmaDisciplina { get; set; } = new TurmaDisciplinaTelaViewModel();
